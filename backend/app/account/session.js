...
// const polo = new Session({username: 'Polo'}); const poloString =
// polo.toString(); console.log('Session.parse(poloString)',
// Session.parse(poloString)) console.log('',
// Session.verify(Session.parse(poloString)));
